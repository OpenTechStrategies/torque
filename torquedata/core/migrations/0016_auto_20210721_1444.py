...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("core", "0015_remove_tableofcontentscache_rendered_data"),
    ]

    def create_wikis(apps, schema_editor):
        classes = [
            apps.get_model("core", "Template"),
            apps.get_model("core", "CellEdit"),
            apps.get_model("core", "SearchCacheRow"),
            apps.get_model("core", "SheetConfig"),
        ]
        Wiki = apps.get_model("core", "Wiki")
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="core.wiki"
            ),
        ),
        migrations.AddField(
