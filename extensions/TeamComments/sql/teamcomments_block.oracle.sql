...
CREATE SEQUENCE TeamComments_block_cb_id_seq;

CREATE TABLE &mw_prefix.TeamComments_block (
...
CREATE INDEX &mw_prefix.cb_user_id ON &mw_prefix.TeamComments_block (cb_user_id);

ALTER TABLE &mw_prefix.TeamComments_block ADD CONSTRAINT &mw_prefix.TeamComments_block_pk PRIMARY KEY (cb_id);
