...
You can access the list of Torque users through the TorqueUserLookup
...
* `torque-admin` - for admin accounts that can upload data, as well as get prompted when the configuration is broken.
